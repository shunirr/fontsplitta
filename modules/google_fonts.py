...
@click.option("--css_url", type=str, default="https://fonts.googleapis.com/css2?family=Noto+Sans+JP")
@click.option("--user_agent", type=str, default="Mozilla/5.0 AppleWebKit/537.36 (KHTML, like Gecko) Chrome/133.0.0.0")
def get_unicode_ranges_from_google_fonts(output_file: str, css_url: str, user_agent: str):
